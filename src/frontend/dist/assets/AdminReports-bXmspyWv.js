const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-DGYn58yZ.js","assets/index-CvDcA4vm.js","assets/index-Boj5QTy1.css"])))=>i.map(i=>d[i]);
import { g as useTestRecords, y as useDeleteTestRecord, u as useAuth, r as reactExports, j as jsxRuntimeExports, B as Button, F as FileText, L as Label, I as Input, S as Skeleton, e as Eye, s as ue, x as IssueFlag, z as reactDomExports, X, _ as __vitePreload } from "./index-CvDcA4vm.js";
...
import { F as Funnel, P as PhotoGallery } from "./PhotoGallery-BYI7_xHl.js";
import { F as FileSpreadsheet, D as Download } from "./file-spreadsheet-DVwPKdHd.js";
import { R as ResponsiveContainer, L as LineChart, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, b as Legend, a as Line, B as Bar, c as Cell } from "./LineChart-BByOfBoE.js";
...
function exportToPdf(ctx) {
  Promise.all([__vitePreload(() => import("./jspdf.es.min-DGYn58yZ.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0), __vitePreload(() => import("./jspdf.plugin.autotable-DHcwasbS.js"), true ? [] : void 0)]).then(

import { a2 as clsx, a3 as React2, a4 as getDefaultExportFromCjs, r as reactExports, g as useTestRecords, b as useVehicleModels, d as useRoutes, j as jsxRuntimeExports, S as Skeleton, F as IssueFlag } from "./index-LhnIGNVd.js";
import { B as Badge } from "./badge-C6aQCMFb.js";
import { C as Card, a as CardHeader, b as CardTitle, d as CardContent } from "./card-BcTxOoEl.js";
import { m as motion } from "./proxy-CY5ES0H4.js";
import { f as filterProps, _ as _baseExtremum, d as _baseGt, e as _baseIteratee, g as _baseLt, i as isFunction, h as Text, p as polarToCartesian, j as Layer, k as getTickClassName, l as adaptEventsOfChild, m as Label, D as Dot, n as Curve, o as isNil, q as getValueByDataKey, S as Shape, A as Animate, r as get, s as interpolateNumber, t as isEqual, u as isNumber, v as LabelList, w as uniqueId, G as Global, x as mathSign, y as findAllByType, c as Cell, z as getMaxRadius, E as getPercentValue, F as warn, H as generateCategoricalChart, I as formatAxisMap, R as ResponsiveContainer, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, L as LineChart, a as Line, b as Legend } from "./LineChart-D6ls80Hk.js";
...
function deriveTopIssues(records) {
  const counts = {};
  for (const r of records) {
    for (const issue of r.issues) {
  ...
  return Object.entries(counts).sort((a, b) => b[1].count - a[1].count).slice(0, 5).map(([flag, data]) => ({ flag, ...data }));
}
function StatCard({
  label,
  value,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card hover:border-primary/30 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold", style: { color }, children: value }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold text-foreground", children: title }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children })
      ] })
    }
  );
}
function TopIssuesPanel({ records }) {
  const topIssues = deriveTopIssues(records);
  if (topIssues.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-32 text-muted-foreground text-sm gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "✅" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "No issues recorded yet" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: topIssues.map((issue, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold truncate text-foreground", children: issue.flag }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate mt-0.5", children: issue.description || issue.lastRecord.vehicleModelName })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground whitespace-nowrap", children: tsToDate(issue.lastRecord.timestamp) })
      ]
    },
    issue.flag
  )) });
...
function RecentActivity({ records }) {
  ...
  if (recent.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground text-center py-6", children: "No records yet" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: recent.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex-1 min-w-0 truncate", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: r.vehicleModelName }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground whitespace-nowrap", children: tsToDate(r.timestamp) })
  ] }, r.id.toString())) });
}
function AnalystDashboard() {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", "data-ocid": "analyst-dashboard-loading", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-56" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: [1, 2, 3, 4].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 rounded-lg" }, k)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [1, 2, 3, 4].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-64 rounded-lg" }, k)) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-6 space-y-6", "data-ocid": "analyst-dashboard", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-foreground", children: "Analyst Dashboard" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "EV fleet test analytics — read-only view" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
            ...
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-semibold flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "Top 5 Issues / Problems" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TopIssuesPanel, { records }) })
              ]
            }
          )
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card", "data-ocid": "recent-activity", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RecentActivity, { records }) })
          ] })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Issue Type Frequency", delay: 0.1, children: issueData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52 flex items-center justify-center text-muted-foreground text-sm", children: "No issue data" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-[340px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      BarChart,
      {
        data: issueData,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "value", name: "Count", radius: [4, 4, 0, 0], children: issueData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Cell,
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Range Achieved per Test (km)", delay: 0.15, children: rangeData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52 flex items-center justify-center text-muted-foreground text-sm", children: "No data yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        LineChart,
        {
          data: rangeData,
          margin: { top: 4, right: 16, left: 0, bottom: 4 },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Speed Trend — Avg vs Top Speed (km/h)", delay: 0.2, children: speedData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52 flex items-center justify-center text-muted-foreground text-sm", children: "No data yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        LineChart,
        {
          data: speedData,
          margin: { top: 4, right: 16, left: 0, bottom: 4 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "SOC % Distribution", delay: 0.25, children: socData.every((d) => d.count === 0) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52 flex items-center justify-center text-muted-foreground text-sm", children: "No data yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        BarChart,
        {
          data: socData,
          margin: { top: 4, right: 16, left: 0, bottom: 4 },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Issue Category Breakdown", delay: 0.3, children: issueData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52 flex items-center justify-center text-muted-foreground text-sm", children: "No issues recorded" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Pie,
          {
            data: issueData,
            ...
            paddingAngle: 3,
            dataKey: "value",
            children: issueData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Cell,
              {
                fill: ISSUE_COLORS[entry.name] ?? ORANGE
              },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            wrapperStyle: { fontSize: "11px", color: CHART_TICK },
            formatter: (value) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.145 0 0)" }, children: value })
          }
        )
      ] }) }) }) }) })
    ] })
